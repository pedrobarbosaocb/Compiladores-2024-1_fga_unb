...
{	int continueParsing = 1;  // Adicionado para controle do loop

    while (continueParsing) {  // Loop principal
		int jm=0;
		int km=0;
		int i,choice;
		char c,ch;
		...
		printf("\nDeseja continuar? Digite 1 para continuar ou 0 para sair: ");
        scanf("%d", &continueParsing);  // Perguntar ao usuário se deseja continuar
		while (getchar() != '\n');
	}
}
